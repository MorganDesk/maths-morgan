    ...
    activeEvents.forEach(event => {
        ...
        banner.innerHTML = `
            ...
            <div class="event-banner-content">
                ...
                <div class="event-banner-desc">${event.description ? event.description : (event.gameId === "TRANSVERSAL" ? "Cumule des points sur tous les jeux confondus !" : `Cumule des points sur <strong>${event.gameId} (${event.gameMode})</strong> !`)}</div>
